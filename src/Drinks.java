...
public class Drinks {
    ...
    Drinks() {
        ...
        mainLabel.setText("WELCOME IN THE DRINKS LIST ");
        ImageIcon main = new ImageIcon("drinks.png");
...
//                }
        ...
        ImageIcon bananaIcon = new ImageIcon("beer.png");
        JLabel bananaLabel = new JLabel();

        bananaLabel.setFont(new Font("cooper black", Font.PLAIN, 25));
        ...
        ImageIcon tomatoIcon = new ImageIcon("coffee.png");
        JLabel tomatoLabel = new JLabel();

        tomatoLabel.setFont(new Font("cooper black", Font.PLAIN, 25));
        ...
        ImageIcon mangoIcon = new ImageIcon("juice.png");
        JLabel mangoLabel = new JLabel();

        mangoLabel.setFont(new Font("cooper black", Font.PLAIN, 25));
        ...
        ImageIcon strawberryIcon = new ImageIcon("tea.png");
        JLabel strawberryLabel = new JLabel();

        strawberryLabel.setFont(new Font("cooper black", Font.PLAIN, 25));
        ...
        ImageIcon broccoliIcon = new ImageIcon("cola.png");
        JLabel broccoliLabel = new JLabel();

        broccoliLabel.setFont(new Font("cooper black", Font.PLAIN, 25));
        ...
        ImageIcon radishIcon = new ImageIcon("wine.png");
        JLabel radishLabel = new JLabel();

        radishLabel.setFont(new Font("cooper black", Font.PLAIN, 25));
